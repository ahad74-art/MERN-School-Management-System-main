...
const StudentDetailsView = () => {
    ...
    const handlePasswordUpdate = (newPassword) => {
        ...
        dispatch(updateUser(updateData, id, "Student"));
    ...
    const handleEditSubmit = () => {
        ...
        setUpdateMessage('Student information updated successfully!');
    ...
    return (
        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
            ...
            <Box display="flex" alignItems="center" mb={3}>
                <IconButton onClick={() => navigate('/Admin/students')} sx={{ mr: 2 }}>
                    <ArrowBack />
                </IconButton>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid item xs={12} sm={6}>
                                            ...
                                            <Typography variant="body1" sx={{ mb: 2 }}>
                                                {userDetails.rollNum || 'Not provided'}
                                            </Typography>
                                        </Grid>
                                        <Grid item xs={12} sm={6}>
                                            <Typography variant="body2" color="textSecondary">
                                            ...
                                            <Typography variant="body1" sx={{ mb: 2 }}>
                                                {userDetails.sclassName?.sclassName || 'Not assigned'}
                                            </Typography>
                                        </Grid>
                                        <Grid item xs={12} sm={6}>
                                            <Typography variant="body2" color="textSecondary">
                                            ...
                                            <Typography variant="body1" sx={{ mb: 2 }}>
                                                {userDetails.school?.schoolName || 'Not provided'}
                                            </Typography>
                                        </Grid>
                                        <Grid item xs={12} sm={6}>
                                            <Typography variant="body2" color="textSecondary">
